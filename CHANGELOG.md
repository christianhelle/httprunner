...
- Fix GUI window icon to use custom icon instead of the default framework icon [\#114](https://github.com/christianhelle/httprunner/pull/114) ([Copilot](https://github.com/apps/copilot-swe-agent))
...
- Upgrade GUI framework dependencies to v0.33 [\#109](https://github.com/christianhelle/httprunner/pull/109) ([christianhelle](https://github.com/christianhelle))
